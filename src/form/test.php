<?php
include "../../src/includes/cssFile.inc.php";
?>
    ...
    <div class="form-container mt-5">
        ...
        <div id="section-1" class="form-section active">
            <form>
                ...
                <div class="mb-3"><br>
                    ...
                    <input type="text" class="form-control" id="institution" readonly
                        value="Universitatea “1 Decembrie 1918” din Alba Iulia">
                </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center shadow-container">
                            <div id="wrap-wrap">
                                <div class="form-check me-3 position-relative">
                                    <input class="form-check-input" type="radio" name="studyType" id="licenta" value="Licență" required>
                                ...
                                <div class="form-check me-3 position-relative">
                                    <input class="form-check-input" type="radio" name="studyType" id="master" value="Master" required>
                                    <label class="form-check-label" for="master">Master</label>
                                    <span class="custom-tooltip">Aceasta este pentru studii de master.</span>
                                </div>
                                <div class="form-check me-3 position-relative">
                                    <input class="form-check-input" type="radio" name="studyType" id="doctorat" value="Doctorat" required>
                                ...
                                <div class="form-check me-3 position-relative">
                                    <input class="form-check-input" type="radio" name="studyType" id="postdoctorat" value="Postdoctorat" required>
                    ...
                    <div class="yr-std">
                        ...
                        <div class="mb-3">
                            <div class="shadow-container">
                                ...
                                <input type="date" class="form-control w-auto" id="yearOfStudyStart" name="yearOfStudyStart" required>
                        ...
                        <div class="mb-3">
                            <div class="shadow-container">
                                ...
                                <input type="date" class="form-control w-auto" id="yearOfStudyEnd" name="yearOfStudyEnd" required>
                                <div class="invalid-feedback">Vă rugăm să introduceți data nașterii.</div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="section-2" class="form-section">
            <form>
                ...
                <!-- Question 4 -->
                <div class="mb-3">
                    <label class="form-label  text-primary">Interacţiunea cu ceilalţi studenţi</label>
                    <div class="d-flex justify-content-between  align-items-center shadow-container">
                        <div class="d-flex">
                            <div id="wrap-wrap">
                                <div class="form-check me-3 position-relative">
                ...
                <!-- Question 5 -->
                <div class="mb-3">
                    <label class="form-label  text-primary">Sistemul de testare / evaluare</label>
                    <div class="d-flex justify-content-between  align-items-center shadow-container">
                        <div class="d-flex">
                            <div id="wrap-wrap">
                                <div class="form-check me-3 position-relative">
                ...
                <!-- Question 12 -->
                <div class="mb-3">
                    <label class="form-label  text-primary">Calitatea predării – utilizarea următoarelor metode de predare - învăţare: prelegeri, demonstrații, participare la proiecte de cercetare, stagii și plasamente de practică, conversaţie profesori – studenţi în timpul cursului/seminarului, dezbateri între studenţi în timpul cursului/seminarului, exerciţii şi aplicaţii practice în timpul cursului/seminarului, învăţarea prin proiecte (alte proiecte decât cele de cercetare) individuale sau de grup, prezentări orale ale studenţilor</label>
                    <div class="d-flex justify-content-between  align-items-center shadow-container">
                        <div class="d-flex">
                            <div id="wrap-wrap">
                ...
                <!-- Question 16 -->
                <div class="mb-3">
                    <label class="form-label  text-primary">Calitatea bibliotecilor</label>
                    <div class="d-flex justify-content-between  align-items-center shadow-container">
                        <div class="d-flex">
                            <div id="wrap-wrap">
                ...
                <!-- Question 17 -->
                <div class="mb-3">
                    <label class="form-label  text-primary">SPosibilitatea participării la stagii de practică la nivel naţional</label>
                    <div class="d-flex justify-content-between  align-items-center shadow-container">
                        <div class="d-flex">
                            <div id="wrap-wrap">
        ...
        <div id="section-3" class="form-section">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <div class="shadow-container">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="option1" value="Angajat">
                            <label class="form-check-label" for="option1">Angajat (inclusiv propriul angajator sau aflat
                                în stagii de pregătire)</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="option2" value="Participant la cursuri">
                            <label class="form-check-label" for="option2">Participant la cursuri de formare
                                profesională</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="option3" value="Studii aprofundate">
                            <label class="form-check-label" for="option3">Înscris la studii universitare aprofundate
                                (masterat, doctorat, alte studii postuniversitare)</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="option4" value="Fără loc de muncă">
                            <label class="form-check-label" for="option4">Fără loc de muncă, dar în căutare de loc de
                                muncă</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="option5" value="Fără intenție de angajare">
                            <label class="form-check-label" for="option5">Fără loc de muncă și fără intenția de a se
                ...
                <div class="mb-3">
                    ...
                    <div class="shadow-container">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="company" id="yes" value="Da" required>
                            <label class="form-check-label" for="yes">Da</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="company" id="no" value="Nu" required>
                ...
                <!-- Question 3 -->
                <div class="mb-3">
                    <label class="form-label text-primary">Tip companie</label>
                    <div class="shadow-container">
                        <div class="form-check">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="companyType" id="sa" value="SA" required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="companyType" id="ii" value="II" required>
                ...
                <div class="mb-3">
                    <label class="form-label text-primary">Domeniul de activitate al companiei</label>
                    <div class="shadow-container">
                        <textarea class="form-control" id="companyActivity" rows="3"
                ...
                <div class="mb-3">
                    ...
                    <div class="shadow-container">
                        <input type="date" class="form-control w-5" id="startYear" name="startYear"
                            placeholder="An început" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="shadow-container">
                        <input type="text" class="form-control" id="currentFunction"
                            placeholder="Scrieți numele funcției deținute">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label text-primary">Postul ocupat corespunde specializării obținute la
                        absolvire?</label>
                    <div class="shadow-container">
                        <div class="form-check">
                ...
                <div class="step-buttons">
                    <button type="button" class="btn btn-secondary" onclick="prevSection()">Pasul Anterior</button>
                    <button type="button" class="btn btn-success" onclick="showSuccessMessage()">Finalizare</button>
                </div>
